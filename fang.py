...
# ──────────────────────────────────────────────────────────────────────────────
# xlsxwriter doesn't reorder sheets natively — we set the first worksheet active
# The Dashboard sheet was added first via wb.add_worksheet so it appears first.
