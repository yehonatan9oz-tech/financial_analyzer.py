...
def calculate_ratios(df_income, df_balance, df_cashflow, overview):
    ...
    for col in df_income.columns:
        ...
        col_ratios['Dividend Yield (%)'] = (dividend_per_share / (market_cap / (df_income.loc[
                                                                                    'commonStockSharesOutstanding', col] if 'commonStockSharesOutstanding' in df_income.index else 1)) * 100) if market_cap != 0 else 0
